...
" />
 ...
 <!---------------Image for tariff---------------------->
 <div class="breadcumb-wrapper" style='background-image:url("assets/img/city/kolkata-banner.jpg"); background-size:cover; repeat:no-repeat' data-overlay="title"
        data-opacity="4">
        <div class="container z-index-common">
            <h1 class="breadcumb-title">Driver Hire for Kolkata</h1>
...
<section class="bg-smoke space overlfow-hidden">
        <div class="container">
            <div class="row">
                <div class="col-sm-8 cityIntro">
                    <p class="mt-3 ">If you're looking for a driver on hire in Kolkata, you've come to the right place. We have the largest database of registered car drivers to choose from for any commuting needs in India, whether it's a driver for an out-of-town trip, a local hourly drive, etc. We have an experience of over a decade in the Driver Service Section.
                            </p>
                    <p>We also take care of corporate clients' needs for renting a car with a driver in Kolkata, let it be for permanent drivers, or contractual drivers.</p>
                </div>
                <div class="col-sm-4 d-none d-md-block">
                    <div>
                        <img src="assets/img/city/kolkata.jpg" alt="driver-hire-in-kolkata-chikucab">
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row slider-shadow as-carousel" id="testi-slide-1" data-slide-show="3" data-lg-slide-show="2"
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="testi-card">
                        <p class="testi-card_text">“Groactively synthesize schemas before foster like leveraged
                            expertise user friendly business low before open source iterate.”</p>
                        <div class="testi-card_profile">
                            <div class="testi-card_img"><img src="assets/img/testimonial/testi_1_1.jpg" alt="Avater" />
                            </div>
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="testi-card">
                        <p class="testi-card_text">“Proactively synthesize schemas before foster like leveraged
                            expertise user friendly business low before open source schemas.”</p>
                        <div class="testi-card_profile">
                            <div class="testi-card_img"><img src="assets/img/testimonial/testi_1_2.jpg" alt="Avater" />
                            </div>
                            <div class="testi-card_info">
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="testi-card">
                        <p class="testi-card_text">“Troactively synthesize schemas before foster like leveraged
                            expertise user friendly business low before open source before.”</p>
                        <div class="testi-card_profile">
                            <div class="testi-card_img"><img src="assets/img/testimonial/testi_1_3.jpg" alt="Avater" />
                            </div>
                            <div class="testi-card_info">
                ...
                <div class="col-md-6 col-xl-4">
                    <div class="testi-card">
                        <p class="testi-card_text">“Jroactively synthesize schemas before foster like leveraged
                            expertise user friendly business low before open source schemas.”</p>
                        <div class="testi-card_profile">
                            <div class="testi-card_img"><img src="assets/img/testimonial/testi_1_4.jpg" alt="Avater" />
                            </div>
                            <div class="testi-card_info">
    ...
    <section class="space">
        <div class="container">
            <div class="col mt-35">
                <h3 class="border-title border-color">Benefits Of Drivers On Call In Kolkata</h3>
            </div>
            <div class="row">
                <div class="col-md-4 mb-5">
                    <div class="service-process h-100">
                        <div><i class="fas fa-car-alt" style="font-size:40px;"></i></div>
                        <h5 class="service-process_title" style="font-size:26px; line-height:2;">Driver Service 24*7
                        </h5>
                ...
                <div class="col-md-4 mb-5">
                    <div class="service-process h-100">
                        ...
                        <h5 class="service-process_title" style="font-size:26px; line-height:2;">Transparent-Fixed Price
                        </h5>
                ...
                <div class="col-md-4 mb-5">
                    <div class="service-process h-100">
                        ...
                        <h5 class="service-process_title" style="font-size:26px; line-height:2;">Trained & Groomed
                            Drivers</h5>
                ...
                <div class="col-md-4 mb-5">
                    <div class="service-process h-100">
                        ...
                        <h5 class="service-process_title" style="font-size:26px; line-height:2;">Registered Drivers</h5>
                        <p class="service-process_text">Largest database with verified drivers..</p>
                    </div>
                </div>
                <div class="col-md-4 mb-5">
                    <div class="service-process h-100">
                        ...
                        <h5 class="service-process_title" style="font-size:26px; line-height:2;">On-time Service</h5>
    ...
    <section class="bg-smoke space">
        <div class="container">
            <div class="col mt-35">
                <h3 class="border-title">Occasions For Car Driver On Hire In Kolkata</h3>
            </div>
            <div class="row">
                <div class="col-md-4 mb-5">
                    <div class="service-feature h-100">
                        ...
                        <div class="service-feature_content">
                            <h4 class="service-feature_title">One Way Drop</h4>
                ...
                <div class="col-md-4 mb-5">
                    <div class="service-feature h-100">
                        ...
                        <div class="service-feature_content">
                            <h4 class="service-feature_title">Shoppings</h4>
                ...
                <div class="col-md-4 mb-5">
                    <div class="service-feature h-100">
                        ...
                        <div class="service-feature_content">
                            <h4 class="service-feature_title">OutStation Drive</h4>
                ...
                <div class="col-md-4 mb-5">
                    <div class="service-feature h-100">
                        ...
                        <div class="service-feature_content">
                            <h4 class="service-feature_title">Meetings</h4>
                ...
                <div class="col-md-4 mb-5">
                    <div class="service-feature h-100">
                        ...
                        <div class="service-feature_content">
                            <h4 class="service-feature_title">Partying Out</h4>
                            <p class="service-feature_text">You can book car drivers on hire in your city to attend
                                multiple meetings & be productive working on your laptop or talking with clients or
                                employees while you are driven in comfort of your own car by our driver.</p>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-4 col-md-6 my-4">
                    <div class="taxi-box shadow">
                        ...
                        <form action="book-a-ride.php" method="POST">
                            <input type="hidden" value="4" name="hours">
                ...
                <div class="col-xl-4 col-md-6 my-4">
                    <div class="taxi-box shadow">
                        ...
                        <form action="book-a-ride.php" method="POST">
                            <input type="hidden" value="8" name="hours">
                            <input type="hidden" value="kolkata" name="city">
                            <button type="submit" class="as-btn">Book Now</button>
                        </form>
                    </div>
                ...
                <div class="col-xl-4 col-md-6 my-4">
                    <div class="taxi-box shadow">
                        ...
                        <form action="book-a-ride.php" method="POST">
                            <input type="hidden" value="12" name="hours">
                            <input type="hidden" value="kolkata" name="city">
                            <button type="submit" class="as-btn">Book Now</button>
                        </form>
                    </div>
                ...
                <div class="col-xl-4 col-md-6 my-4">
                    <div class="taxi-box shadow">
                        ...
                        <div class="btnFix">
                        <form action="book-a-ride.php" method="POST">
                            <input type="hidden" value="5" name="hours">
                            <input type="hidden" value="kolkata" name="city">
                            <button type="submit" class="as-btn">Book Now</button>
                        </form>
                        </div>
                ...
                <div class="col-xl-4 col-md-6 my-4">
                    <div class="taxi-box shadow">
                        ...
                        <form action="book-a-ride.php" method="POST">
                            <input type="hidden" value="7" name="hours">
                            <input type="hidden" value="kolkata" name="city">
                            <button type="submit" class="as-btn">Book Now</button>
                        </form>
                    </div>
                ...
                <div class="col-xl-4 col-md-6 my-4">
                    <div class="taxi-box shadow">
                        ...
                        <p class="taxi-box_rate" style="font-size:16px;"><strong>Intra City</strong>
                            <strong>–INR 850/- for 12 hours</strong><br><strong>Stay-INR 850/-</strong>per day.</p>
                        <div class="taxi-feature">
                            <i aria-hidden="true" style="font-size:18px;" class="fas fa-check-circle"></i>
                            <h2 class="taxi-feature_title">Luxury Charge – INR 100/-</h2>
                        </div>
                        ...
                        <div class="taxi-feature">
                            <i aria-hidden="true" style="font-size:18px;" class="fas fa-check-circle"></i>
                            <h2 class="taxi-feature_title">Accomodation–INR 250/-per Night</h2>
                        </div>
                        <div class="taxi-feature">
                            <i aria-hidden="true" style="font-size:18px;" class="fas fa-check-circle"></i>
                            <h2 class="taxi-feature_title">Food Allowance–INR 250/-@ 11 pm</h2>
                        </div>
                        <div class="taxi-feature">
                            <i aria-hidden="true" style="font-size:18px;" class="fas fa-check-circle"></i>
                            <h2 class="taxi-feature_title">Late Night Allowance at 12 am–INR 200/-</h2>
                        </div>
                        <div class="taxi-feature">
                            <i aria-hidden="true" style="font-size:18px;" class="fas fa-check-circle"></i>
                            <h2 class="taxi-feature_title">Booking Before 7 am – INR 100/-</h2>
                        ...
                        <form action="book-a-ride.php" method="POST">
                            <input type="hidden" value="9" name="hours">
                            <input type="hidden" value="kolkata" name="city">
                            <button type="submit" class="as-btn">Book Now</button>
                        </form>
                    </div>
    ...
    <section class="space bg-smoke">
        <div class="container">
            <div class="row mt-5">
                ...
                <br>
                <p class="text-center">You can book Noida to Lucknow from CallForDriver at affordable rates and we will
                    provide you with the best services. Other popular routes include Kolkata to Chandigarh one way drop,
                    Gurgaon to Jaipur one way Driver, Ghaziabad to Kanpur one way driver and Kolkata to Bihar one way
                    driver. You can also take one way cabs from Kolkata to various routes which include Kolkata to Agra one
                    way driver, Kolkata to Punjab one way drop, and Kolkata to Varanasi one way driver. Booking one-way
                    driver service at CallForDriver will help you travel comfortably and also reach on time.
                    CallForDriver takes all the responsibility to provide the best fares for your one-way drop. Book one
                    way driver at CallForDriver and enjoy your journey.</p>
                <div class="col-xl-4 col-lg-4  col-md-4 col-sm-12 justify-content-center">
                    <div class="bg-white p-3 mt-4">
                        ...
                        <table class="table table-sm table-striped border ">
                            <thead>
                                <tr>
                                    <th class="px-3" scope="col">Kolkata To City</th>
                ...
                <div class="col-xl-4 col-lg-4  col-md-4 col-sm-12 justify-content-center">
                    <div class="bg-white p-3 mt-4">
                        <h4 class="text-center">Uttrakhand</h4>
                        <table class="table table-sm table-striped border">
                            <thead>
                                <tr>
                                    <th class="px-3" scope="col">Kolkata To City</th>
                ...
                <div class="col-xl-4 col-lg-4  col-md-4 col-sm-12 justify-content-center">
                    <div class="bg-white p-3 mt-4">
                        <h4 class="text-center">Punjab</h4>
                        <table class="table table-sm table-striped border">
                            <thead>
                                <tr>
                                    <th class="px-3" scope="col">Kolkata To City</th>
                ...
                <div class="col-xl-4 col-lg-4  col-md-4 col-sm-12 justify-content-center">
                    <div class="bg-white p-3 mt-4">
                        <h4 class="text-center">Maharashtra &amp; Gujrat</h4>
                        <table class="table table-sm table-striped border">
                            <thead>
                                <tr>
                                    <th class="px-3" scope="col">Kolkata To City</th>
