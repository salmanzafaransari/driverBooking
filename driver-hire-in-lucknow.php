...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="assets/assets/img/favicons/favicon.ico" />
    <meta name="msapplication-TileColor" content="#FFFFFF
" />
    <meta name="msapplication-TileImage" content="assets/assets/img/favicons/favicon.ico" />
...
" />
 ...
 <!---------------Image for tariff---------------------->
 <div class="breadcumb-wrapper" style='background-image:url("assets/img/city/lucknow-banner.jpg"); background-size:cover;' data-overlay="title"
        data-opacity="4">
        <div class="container z-index-common">
            <h1 class="breadcumb-title">Driver Hire for Lucknow</h1>
...
<section class="bg-smoke space overlfow-hidden">
        <div class="container mb-5">
            <div class="row">
                <div class="col-sm-8 cityIntro">
                    <p class="mt-3 "><strong>If you're looking for a driver on hire in lucknow, you've come to the right place. We have the largest database of registered car drivers to choose from for any commuting needs in India, whether it's a driver for an out-of-town trip, a local hourly drive, etc. We have an experience of over a decade in the Driver Service Section.
                            </strong></p>
                    <p><strong>We also take care of corporate clients' needs for renting a car with a driver in lucknow, let it be for permanent drivers, or contractual drivers.</strong></p>
                </div>
                <div class="col-sm-4 d-none d-md-block">
                    <div>
                        <img src="assets/img/city/lucknow.jpg" alt="driver-hire-in-lucknow-chikucab">
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="space">
        <div class="container">
            <div class="col mt-35">
                <h3 class="border-title border-color">Benefits Of Drivers On Call In Lucknow</h3>
            </div>
            <div class="row">
    ...
    <section class="bg-smoke space">
        <div class="container">
            <div class="col mt-35">
                <h3 class="border-title">Occasions For Car Driver On Hire In Lucknow</h3>
            </div>
            <div class="row">
                <div class="col-md-4 mb-5">
                ...
                <div class="col-xl-4 col-md-6 my-4">
                    <div class="taxi-box shadow">
                        ...
                        <form action="book-a-ride.php" method="POST">
                            ...
                            <input type="hidden" value="lucknow" name="city">
        ...
        <div class="container">
            <div class="row mt-5">
                ...
                <p class="text-center">You can book Noida to Lucknow from CallForDriver at affordable rates and we will
                    provide you with the best services. Other popular routes include lucknow to Chandigarh one way drop,
                    Gurgaon to Jaipur one way Driver, Ghaziabad to Kanpur one way driver and lucknow to Bihar one way
                    driver. You can also take one way cabs from lucknow to various routes which include lucknow to Agra one
                    way driver, lucknow to Punjab one way drop, and lucknow to lucknow one way driver. Booking one-way
                ...
                <div class="col-xl-4 col-lg-4  col-md-4 col-sm-12 justify-content-center">
                    <div class="bg-white p-3 mt-4">
                        ...
                        <table class="table table-sm table-striped border ">
                            <thead>
                                <tr>
                                    <th class="px-3" scope="col">Lucknow To City</th>
