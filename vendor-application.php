...
<section class="space">
    <div class="container">
        <h2 class="txt-theme-color">Vendor Application</h2>
        <p><a class="txtblack" href="https://chikucab.com/agreement/chikucab.com_vendor_agreement.pdf"><strong>Kindly click here to read carefully Taxi Operator Agreement</strong></a></p>
        <div class="row">
            <div class="position-relative col-md-8">
                ...
                <form action="#" method="POST"
                    ...
                    <div class="row">
                        ...
                        <strong>Upload Signature Of Vendor</strong>
                         </div>
