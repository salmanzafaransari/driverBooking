      ...
      <div class="container">
        ...
        <form action="" method="POST" class="booking-form4">
          <div class="row">
            ...
            <div class="form-group col-sm-6"><input type="text" required class="form-control" autocomplete="off"  name="name" id="name" placeholder="Your Name" /> <i class="fal fa-user"></i></div>
