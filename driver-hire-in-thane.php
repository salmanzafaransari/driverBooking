...
" />
 ...
 <!---------------Image for tariff---------------------->
 <div class="breadcumb-wrapper" style='background-image:url("assets/img/city/thane-banner.jpg"); background-size:cover; repeat:no-repeat;' data-overlay="title"
        data-opacity="4">
        <div class="container z-index-common">
            <h1 class="breadcumb-title">Driver Hire for Thane</h1>
...
<section class="bg-smoke space overlfow-hidden">
    ...
    <section class="space">
        <div class="container">
            <div class="col mt-35">
                <h3 class="border-title border-color">Benefits Of Drivers On Call In Thane</h3>
            </div>
            <div class="row">
    ...
    <section class="bg-smoke space">
        <div class="container">
            <div class="col mt-35">
                <h3 class="border-title">Occasions For Car Driver On Hire In Thane</h3>
            </div>
            <div class="row">
                <div class="col-md-4 mb-5">
                ...
                <div class="col-xl-4 col-md-6 my-4">
                    <div class="taxi-box shadow">
                        ...
                        <form action="book-a-ride.php" method="POST">
                            ...
                            <input type="hidden" value="thane" name="city">
        ...
        <div class="container">
            <div class="row mt-5">
                ...
                <p class="text-center">You can book Noida to Lucknow from CallForDriver at affordable rates and we will
                    provide you with the best services. Other popular routes include Thane to Chandigarh one way drop,
                    Gurgaon to Jaipur one way Driver, Ghaziabad to Kanpur one way driver and Thane to Bihar one way
                    driver. You can also take one way cabs from Thane to various routes which include Thane to Agra one
                    way driver, Thane to Punjab one way drop, and Thane to Varanasi one way driver. Booking one-way
                ...
                <div class="col-xl-4 col-lg-4  col-md-4 col-sm-12 justify-content-center">
                    <div class="bg-white p-3 mt-4">
                        ...
                        <table class="table table-sm table-striped border ">
                            <thead>
                                <tr>
                                    <th class="px-3" scope="col">Thane To City</th>
